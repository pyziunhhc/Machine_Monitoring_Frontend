...
import Belt from "../../../atoms/Belt/Belt";
...
export default class AddTaskWindow extends Component {
  ...
  componentDidMount(){
    this.props.getRef(this.container.ref)
  }
  componentWillUnmount(){
    this.container.ref.current.classList.add('removed')
  }
  render() {
    return (
      <div className="add-task__wrapper" ref={this.container.ref}>
        <Belt container={this.container} title="Dodaj nowe zadanie" removeWindow={this.props.removeAddTaskWindow} />
